      ...
      <div className="flex md:flex-row flex-col-reverse px-4 lg:px-40">
        <div className="basis-1/2 mt-4 md:mt-0">
          ...
          <div className=" mt-3 mb-4 text-[#808080]">
            <p>
              "We've spent 2 years crafting an unparalleled experience for our
              engineers, leading to 98% retention and high performance."
            </p>
            <p className="mt-5">
              {" "}
              "Our thriving culture and continuous investment in our community
              ensures your team is driven, highly motivated, and ready to propel
