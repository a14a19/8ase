      ...
      <>
         <div className="flex space-x-4 overflow-x-auto">
            <div className="flex flex-col justify-center">
               <div className="flex flex-col border h-3/4 justify-center items-center text-3xl font-extrabold w-[20rem]">
                  THE FUTURE <br /> OF WORK <br /> IS HERE.
                  <div className="mt-4">
                     <button
                        className="border rounded-full px-5 py-4 bg-black text-white"
            ...
            <div className="flex space-x-4">
               {EmployeeReviewsData.map((data, index) => (
                  <div
                     key={index}
                     className={`flex flex-col border rounded-2xl p-6 w-[20rem] h-[28rem] ${
                        index % 2 === 0
                  ...
                  >
                     ...
                     <div className="flex text-2xl text-left mt-6">
                        {data.review}
                     </div>
